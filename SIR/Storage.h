...
public:
	...
	void endMovieSave();
	void movieSave(int ID, string name, double t, double coord[2], string location, char state, list<int> SIconnections, list<int> SIconnectionsHist, list<int> Allconnections, list<int> AllconnectionsHist);
	void citySave();
	void homeSave();
	void workSave();
	void schoolSave();
